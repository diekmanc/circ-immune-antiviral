...
taux=24.2;
K=0.55;
alpha0=0.05; Beta=0.0075; G=33.75; pp=0.5; % 2013 paper
zeta0=9500;
...
for dx = 1:numDays
    for hx = 1:24
        ...
        if stopFlag == 0
            ...
            [t_temp,u_temp,te,ye,ie] = ode15s(@goyal_with_k3d_treatment_3_20_23_19fold_3_3_25,tin,inits,options);
            t = [t; t_temp];
            u = [u; u_temp];
            if length(te) > 0
                stopFlag = 1;
